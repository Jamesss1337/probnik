--
-- Файл сгенерирован с помощью SQLiteStudio v3.3.3 в Пт апр 29 01:16:23 2022
--
...
-- Таблица: Average
CREATE TABLE Average (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "average	" DOUBLE NOT NULL);
...
-- Таблица: Player
CREATE TABLE Player (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name STRING NOT NULL, age INTEGER NOT NULL, gender_id REFERENCES Gender (id) NOT NULL, country_id REFERENCES Country (id) NOT NULL);
INSERT INTO Player (id, name, age, gender_id, country_id) VALUES (1, 'Jonny Clayton', 47, 1, 27);
INSERT INTO Player (id, name, age, gender_id, country_id) VALUES (2, 'Gary Anderson', 51, 1, 4);
